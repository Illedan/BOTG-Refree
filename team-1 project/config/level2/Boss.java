...
buys a single item, always the cheapest

attacks nearest tower to make it easier due to having more health than any hero in game

it can be easily defeated by just buying better items and selecting a stronger hero for this league
...
class Player {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < doodads; i++) {
            ...
            bushes.add(new Doodah(x, y, radius));
        }
        ...
        while (true) {
            ...
            if(roundType == -1) System.out.println("DOCTOR_STRANGE");
                ...
                for (Hero myHero : myHeroes) {
                    ...
                    } else if(gold >= itemCost && myHero.itemCount < 1){
                            gold-=itemCost;
                            System.out.println("BUY " + cheapestItem);
                    } else
                        System.out.println("ATTACK_NEAREST TOWER");
                }
            turn++;
        }
    }
